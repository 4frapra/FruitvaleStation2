                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            firstTrainTextView.setText("Train in: " + firstTrainMinutes);
                            secondTrainTextView.setText("Next train in: " + secondTrainMinutes);
                            thirdTrainTextView.setText("Next train in: " + thirdTrainMinutes);
